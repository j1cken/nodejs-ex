...
sh 'curl -i -s http://master-nodejs-integration.atmy.openshift.cloud | head -1 |grep 200; exit $?'
...
stage 'test uat'
sh 'curl -i -s http://helloworld-nodejs-uat.atmy.openshift.cloud | head -1 |grep 200; exit $?'
